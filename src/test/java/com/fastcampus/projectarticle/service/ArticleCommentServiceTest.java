...
class ArticleCommentServiceTest {
    ...
    private ArticleCommentDto createArticleCommentDto(String content) {
        return ArticleCommentDto.of(1L, 1L, createUserAccountDto(), content, LocalDateTime.now(),
                "yang", LocalDateTime.now(), "yang"
        );
    }

    private UserAccountDto createUserAccountDto() {
        return UserAccountDto.of(1L, "yang", "password", "yang@mail.com", "Uno",
    ...
    private UserAccount createUserAccount() {
        return UserAccount.of("yang", "password", "yang@email.com", "Uno", null);
    }
